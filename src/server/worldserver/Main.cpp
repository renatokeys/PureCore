...
extern int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.worldserver", "%s (Daemon)", _FULLVERSION);
    TC_LOG_INFO("server.worldserver", "<Ctrl-C> para parar.\n");
    TC_LOG_INFO("server.worldserver", " _________                       ");
    TC_LOG_INFO("server.worldserver", "\ \   __  \                                ________");
    TC_LOG_INFO("server.worldserver", " \ \  \__\ \  ____    __    __  _  ______  \ \  ___\  _______  __  _  ______");
    TC_LOG_INFO("server.worldserver", "  \ \  _____\ \ \ \   \ \  /\ \/ \/\   __\  \ \ \__/ /\  __  \/\ \/ \/\   __\");
    TC_LOG_INFO("server.worldserver", "   \ \ \____/  \ \ \   \ \ \ \  __\\ \  \//  \ \ \   \ \ \ \  \ \  __\ \  \//");
    TC_LOG_INFO("server.worldserver", "    \ \ \       \ \ \___\ \ \ \ \_/\ \  /__   \ \ \___\ \ \_\  \ \ \_/\ \  /__");
    TC_LOG_INFO("server.worldserver", " 	\ \_\       \ \_______\ \ \_\  \ \____\   \ \_____\ \______\ \_\  \ \____\");
    TC_LOG_INFO("server.worldserver", "      \/_/        \/_______/  \/_/   \/____/    \______/\/______/\/_/   \/____/");
    TC_LOG_INFO("server.worldserver", "http://zdogames.com");
    TC_LOG_INFO("server.worldserver", "Config %s.", configFile.c_str());
    TC_LOG_INFO("server.worldserver", "Versão ssl: %s (library: %s)", OPENSSL_VERSION_TEXT, SSLeay_version(SSLEAY_VERSION));
    TC_LOG_INFO("server.worldserver", "Versão Boost: %i.%i.%i", BOOST_VERSION / 100000, BOOST_VERSION / 100 % 1000, BOOST_VERSION % 100);
